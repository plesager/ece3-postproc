...
# Where to find EMoP:
export EMOP_DIR="$ROOT/ecearth3/post/timeseries"
...
export TMPDIR_ROOT="/marconi_scratch/userexternal/${USERme}/tmp/timeseries"
...
export EMOP_CLIM_DIR="/marconi/home/userexternal/${USERme}/ecearth3/diag"
...
export NEMO_MESH_DIR="$ROOT/ecearth3/nemo/$NEMOCONFIG"
...
export CDFTOOLS_BIN="/marconi_work/Pra13_3311/cdftools/3.0/bin"

# The scrip "rebuild" as provided with NEMO (relies on flio_rbld.exe):
export RBLD_NEMO="$ROOT/ecearth3/rebuild_nemo/rebuild_nemo"
