...
export CONF_INI_DIR="/marconi/home/userexternal/abalanzi/scratch/ECE-DATA/input_barakuda/ORCA1.L75_barakuda"
...
export MM_FILE=$WORK/ecearth3/nemo/ORCA1L75/mesh_mask.nc
export BM_FILE=$WORK/ecearth3/nemo/ORCA1L75/basin_mask.nc
